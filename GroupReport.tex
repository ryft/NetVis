...
23	23	        \begin{itemize}
24	24	              
25	 	 -            \item \textbf{Heat Map}
 	25	 +            \item \textbf{Heat Map} A hexagonal grid displaying clients active in the network. Color indicated how much data is being transferred. Nodes "heat up" when amount of data goes over specified threshold and "heat down" in time.
26	26	  
27	27	              \item \textbf{Ports}
28	28	  
0 notes on commit b607f80 
